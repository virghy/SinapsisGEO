       ...
       [WebMethod]
        ...
        { 
            ...
            using (DAL.SinapsisEntities dm = new DAL.SinapsisEntities())
            {
                ...
                var rpt = dm.sys_ReportesGEO.Find(IdReporte);
        ...
        public Cliente GetCliente(int IdCliente)
        {
            ...
            using (DAL.SinapsisEntities db = new DAL.SinapsisEntities())
            {
                ...
                if (cl !=null)
                {
                    ...
                    cliente.RUC = cl.RUC ;
                    cliente.Obs = cl.obs ;
                    cliente.Diplomatico = cl.Diplomatico;
...
//            Cliente cliente = new Cliente();
        ...
        public Pedidos GetPedidobyId(int IdPedido)
        {
            ...
            using (DAL.SinapsisEntities db = new DAL.SinapsisEntities())
            {
                ...
                var lc = (from p in db.tel_Pedidos.Include("tel_pedidosDet").Include("tel_TipoPedido").Include("tel_FormaPago").Include("tel_pedidosDet.tel_Productos")
                         ...
                         if (lc !=null)
	                        {
                             ...
                             pd.FormaPago = lc.tel_FormaPago.FormaPago;
        ...
        {
            using (WebApplication1.gisEntities db = new WebApplication1.gisEntities())
            {
                List<string> customers = new List<string>();
                List<WebApplication1.Calles> clist = new List<WebApplication1.Calles>();
                var c = db.BuscarCalle(Nombre, 10).ToList();
                foreach (var item in c)
                {
                    WebApplication1.Calles cl = new WebApplication1.Calles();
        ...
        [WebMethod]
        public Cuadrantes GetCuadrante(Callejero cal)
        {
            return GetCuadrante1(cal.Calle1, cal.Calle2, cal.Calle3, cal.Nro);
        }

        [WebMethod]
        public Cuadrantes GetCuadrante1(string Calle, string Calle1, string Calle2, string Nro)
        {
            using (gisEntities db = new gisEntities())
            {
                ...
                int NroCasa=0;
                if (Nro.Length>0 && int.TryParse(Nro,out NroCasa) )
                {
                    NroCasa = Convert.ToInt32(Nro);
                }

                db.BuscarCuadranteNombre(Global.IdEmpresa, Calle, NroCasa, Calle1, Calle2, pCuadrante,
