<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SinapsisGEO.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:CreateUserWizard runat="server" ID="RegisterUser" ViewStateMode="Disabled" OnCreatedUser="RegisterUser_CreatedUser" LoginCreatedUser="False">
        <LayoutTemplate>
            ...
            <asp:CreateUserWizardStep runat="server" ID="RegisterUserWizardStep">
                <ContentTemplate>
                    ...
                    <fieldset>
                        ...
                        <ol>
                            <li>
                                <asp:Label ID="Label1" runat="server" AssociatedControlID="txtNombre">Nombre</asp:Label>
                            ...
                            <li>
                                <asp:Label ID="Label2" runat="server" AssociatedControlID="txtApellido">Apellido</asp:Label>
