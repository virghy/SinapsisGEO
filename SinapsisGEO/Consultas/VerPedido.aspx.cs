...
namespace SinapsisGEO.Consultas
{
    public partial class VerPedido : System.Web.UI.Page
    {
        ...
        public IQueryable<DAL.tel_Pedidos> GetPedidos([QueryString] int? IdPedido, [Control("txtNroPedido")] int? NroPedido)
        {
            //int? NroPedido=null;
            ...
            var query = this.db.tel_Pedidos.Include("tel_PedidosDet").Include("tel_PedidosDet.tel_Productos").Include("tel_TipoPedido").Include("tel_FormaPago").Where(p => p.IdEmpresa == Global.IdEmpresa & (p.IdPedido==IdPedido | p.NroPedido==NroPedido));
        ...
        protected void ThemeButton1_Click(object sender, EventArgs e)
        {
